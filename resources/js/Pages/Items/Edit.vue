<script setup>
    ...
    const updateItem = id => { // 変数の中に関数を記述できる
     Inertia.put(route('items.update', { item:id }), form) // クリックしたタイミングでポスト通信する
    }
    </script>
                                ...
                                <form @submit.prevent="updateItem(form.id)">
                                    <div class="container px-5 py-8 mx-auto">
                                        ...
                                        <div class="flex flex-wrap -m-2">
                                            ...
                                            <div class="p-2 w-full">
                                            <div class="relative">
                                                <label for="memo" class="leading-7 text-sm text-gray-600"><meta http-equiv="X-UA-Compatible" content="IE=7">メモ</label>
